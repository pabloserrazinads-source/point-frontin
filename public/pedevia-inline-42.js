...
(function(){
  ...
  async function refreshMasterSlotV13230(force){
    ...
    slot.innerHTML=moreCard('🏪','Sites dos clientes','Painel mestre para cadastrar, criar e administrar estabelecimentos','openClientSitesMasterV120()');
  }
